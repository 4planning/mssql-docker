...
{
    try {
      Get-WinEvent -FilterHashtable @{ LogName='Application'; ProviderName='MSSQL*'; StartTime=$lastCheck } -Verbose:$false -ErrorAction SilentlyContinue | Select-Object TimeCreated, Id, LevelDisplayName, Message
    }
    catch {
