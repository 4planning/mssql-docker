...
1. **Applies to:** SQL Server 2022 Express, Windows Server Core 2019 LTSC
5. **Authors:** Perry Skountrianos [perrysk-msft], Maksym Sadovnychyy [maks-it]
...
(Note the you'll need Windows Server 2019 LTSC or Windows 10)
